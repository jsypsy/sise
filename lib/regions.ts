export const REGIONS: Record<string, Record<string, string>> = {
  ...
  // 2026-07-01 인천 행정체제 개편: 중구내륙+동구→제물포구(28125), 중구섬→영종구(28155),
  // 서구남부→서해구(28275), 서구북부→검단구(28290). 코드는 MOLIT API probe로 확정(법정동 대조).
  "인천광역시": {
    "28125":"제물포구","28155":"영종구","28177":"미추홀구","28185":"연수구","28200":"남동구",
    "28237":"부평구","28245":"계양구","28275":"서해구","28290":"검단구","28710":"강화군","28720":"옹진군",
  },
  // 2026-07-01 광주광역시+전라남도 → 전남광주통합특별시(prefix 12). 기초단체 명칭·관할은 유지,
  // 코드만 재부여(시 5 → 12110~12190, 광주 구 5 → 12210~12330, 군 17 → 12710~12870 순차).
  // MOLIT API probe 읍면동 샘플로 전 코드 확정.
  "전남광주특별시": {
    ...
    "12810":"무안군","12820":"함평군","12830":"영광군","12840":"장성군",
    "12850":"완도군","12860":"진도군","12870":"신안군",
  },
  "대전광역시": {
  ...
  "경기도": {
    "41110":"수원시 장안구","41113":"수원시 권선구","41115":"수원시 팔달구","41117":"수원시 영통구",
    "41130":"성남시 수정구","41131":"성남시 중원구","41133":"성남시 분당구",
  ...
  "전북특별자치도": {
    ...
    "52130":"군산시","52140":"익산시","52180":"정읍시","52190":"남원시","52210":"김제시",
  ...
  "경상북도": {
    ...
    "47210":"영주시","47220":"영천시","47230":"상주시","47250":"문경시","47290":"경산시",
    "47730":"의성군","47740":"청송군","47760":"영양군","47770":"영덕군",
...
export const CODE_TO_SIDO: Record<string, string> = Object.fromEntries(
  Object.entries(REGIONS).flatMap(([sido, m]) =>
    Object.keys(m).map((code) => [code, sido]))
);

const SIDO_ABBR: Record<string, string> = {
  "서울특별시":"서울","부산광역시":"부산","대구광역시":"대구","인천광역시":"인천",
  "전남광주특별시":"전남광주","대전광역시":"대전","울산광역시":"울산","세종특별자치시":"세종",
...
export const CODE_TO_NAME: Record<string, string> = Object.fromEntries(
  Object.entries(REGIONS).flatMap(([sido, m]) =>
    Object.entries(m).map(([code, gu]) => [code, `${SIDO_ABBR[sido] ?? sido} ${gu}`]))
);
